...
const Faq = () => {
  const [faqdis,setFaqdis]=useState(true)
  const [naruto,setNaruto]=useState(true)
  const [suske,setSuske]=useState(true)
  const [sakura,setSakura]=useState(true)
  const [hinata,setHinata]=useState(true)
  const [negi,setNegi]=useState(true)
  const [boruto,setBoruto]=useState(true)
  const [kurama,setKurama]=useState(true)
  const [gaara,setGaara]=useState(true)
  const [lee,setLee]=useState(true)
  const [guy,setGuy]=useState(true)
  const [kakashi,setKakashi]=useState(true)
  const [itachi,setItachi]=useState(true)
  const [sukuna,setSukuna]=useState(true)
  const [minato,setMinato]=useState(true)
  const [jiraya,setJiraya]=useState(true)
  const [shanks,setShanks]=useState(true)
  ...
  return (
    <div className='faqmain'>
      ...
      <p className='faqtexthead' onClick={()=>setFaqdis(false)}>1. What is background verification (BGV)?</p>
      {faqdis ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setNaruto(false)}>2. What is the potential impact of not doing background verification?</p>
      {naruto ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setSuske(false)}>3. How can we start BGV of our employees?</p>
      {suske ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setSakura(false)}>4. How much time does it take for BGV process to complete?</p>
      {sakura ? "": <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setHinata(false)}>5. What checks can be conducted under BGV? Do you have fixed packages, or can we customize the checks as per our requirement?</p>
      {hinata ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setNegi(false)}>6. Can the candidate register directly and upload data, documents and consent for BGV?</p>
      {negi ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setBoruto(false)}>7. Are documents required for BGV? Are scans good enough? How are documents collected for BGV?</p>
      {boruto ? "" : <div>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setKurama(false)}>8. Candidate has not submitted complete information or documents. How can you help us?</p>
      {kurama ? "" : <div className='faqtextbox'>
        <p>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setGaara(false)}>9. We want to verify our customers? Can we do that?</p>
      {gaara ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setLee(false)}>10. We want to verify our platform users (or providers or merchants). Can we do that?</p>
      {lee ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setGuy(false)}>11. What are the information security and privacy measures that OnGrid has in place?</p>
      {guy ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setKakashi(false)}>12. How can we take consent from the candidates who go through BGV?</p>
      {kakashi ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead' onClick={()=>setItachi(false)}>13. I have a question which is not mentioned here. How do I reach out?</p>
      {itachi ? "" : <div className='faqtextbox'>
      ...
      <p className='faqtexthead'  onClick={()=>setSukuna(false)}>1.I got a registration link from OnGrid, what needs to be done?</p>
      {sukuna ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead'  onClick={()=>setMinato(false)}>2.I got a digital address verification link from OnGrid, what needs to be done?</p>
      {minato ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead'  onClick={()=>setJiraya(false)}>3.I got an address verification letter from OnGrid, what needs to be done?</p>
      {jiraya ? "" : <div className='faqtextbox'>
        <p>
      ...
      <hr />
      <p className='faqtexthead'  onClick={()=>setShanks(false)}>4.How does OnGrid protect my data and documents?</p>
      {shanks ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead'  onClick={()=>setGold(false)}>5.My record is on OnGrid. I want to edit or delete it. How do I go about doing it?6.I have a question which is not mentioned here. How do I reach out?</p>
      {gold ? "" : <div className='faqtextbox'>
      ...
      <hr />
      <p className='faqtexthead'  onClick={()=>setDark(false)}>6.I have a question which is not mentioned here. How do I reach out?</p>
      {dark ? "" : <div className='faqtextbox'>
